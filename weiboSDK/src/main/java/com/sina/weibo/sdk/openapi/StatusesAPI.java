...
public class StatusesAPI extends AbsOpenAPI {
    ...
    private static final int READ_API_EMOJI = 6;
    ...
    static {
        ...
        sAPIList.put(READ_API_EMOJI,             API_SERVER  + "/emotions.json");
    }
    ...
    * */
    ...
    public  void getEmotions(String type,String language,RequestListener listener){
        ...
        WeiboParameters params = buildEmotions(type,language);

        requestAsync(sAPIList.get(READ_API_EMOJI),params,HTTPMETHOD_GET,listener);
    ...
    public  void repost(long id,String status,int is_comment,String rip, RequestListener listener){
        WeiboParameters params = buildRepost(id,status,is_comment,rip);
    ...
    private  WeiboParameters buildEmotions(String type,String language){
        WeiboParameters params = new WeiboParameters(mAppKey);
    ...
    private  WeiboParameters buildRepost(long id,String status,int is_comment,String rip){
           WeiboParameters params = new WeiboParameters(mAppKey);
        params.put("id",id);
